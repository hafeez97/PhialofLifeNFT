 ...
 *   using the `setMerkleRoot` function defined in GongMaster-x.sol contract. For this script to work your contract
...
async function main() {
  const nftFactory = await hre.ethers.getContractFactory('TestBeautyQueensNFT')
  const nftContract = await nftFactory.attach(
    '0x52c9090740dECD6314b5C3075f4a383C090d8d24' // Deployed contract address
  )
